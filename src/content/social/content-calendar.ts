...
export const contentCalendar: ScheduledPost[] = [
  ...
  // ── WEEK 1 — TikTok ──────────────────────────────────────
  {
    ...
    caption: "¿Cómo empiezo a soltar? El ritual japonés que lo cambia todo. #soltar #konmari #kupurimedia",
    hashtags: ["#soltar", "#konmari", "#kupurimedia"],
  ...
  },
  {
    ...
    caption: "Tres pasos para soltar. No es lo que crees. #soltar #bienestar #mujer",
    hashtags: ["#soltar", "#bienestar", "#mujer", "#kupurimedialatam"],
    imageRef: "tt-02-intro-slate",
    status: "draft",
  },
  ...
  },
  {
    ...
    caption: "どんな女性になりたいか？\n¿Qué tipo de mujer deseas ser?\n\nSOLTAR nació para acompañar a mujeres en la transición más íntima: la de soltar lo que ya no las representa.\n\nKupuri Media · Disponible cuando quieras.",
